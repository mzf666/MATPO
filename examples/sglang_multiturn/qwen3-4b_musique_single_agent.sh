# tested on 1 x (8 x 80G-A800) node
...
TOOL_CONFIG_PATH=$PROJECT_DIR/examples/sglang_multiturn/config/tool_config/mcp_tool_config_full.yaml

MODEL_CHEKPOINT_PATH=/workspace/models/Qwen/Qwen3-4B

config_name=simpleqa_multiturn_rm_batch_grpo
project_name=MATPO
...
experiment_name=train_Qwen3-4B_single_agent_MUSIQUE_GAIA_REPEAT_8
